...
export function dressWindgate10(ctx,island){
 ...
 const wp=[],wc=[],wu=[],wi=[],cross=[[-3.52,-.32],[-3.52,1.92]];
 for(let j=1;j<20;j++){const a=j/20*Math.PI;cross.push([-3.52*Math.cos(a),1.92+2.56*Math.sin(a)]);}cross.push([3.52,1.92],[3.52,-.32]);
